...
<AppLayout theme="auto" >
  ...
  >
      ...
      <div class="space-y-8">
				...
				<div class="w-full min-h-54  bg-primary-500 overflow-hidden rounded-2xl grid grid-cols-1 md:grid-cols-2 gap-4">
					<div class="px-4 md:px-12 py-6 md:py-8">
						<h1 class="text-primary-100 text-3xl">
							Teacher Promotion
						</h1>
						<p class="text-primary-300 text-xl">
							Subtitle
						</p>
					</div>
					<figure class="relative">
						<img src="/assets/teaser/teacher.svg" class="absolute -right-0 -bottom-32" alt="teacher">
					</figure>
				</div>
        ...
        <div class="bg-primary-50 border border-primary-200 rounded-lg p-4">
          <h3 class="font-semibold text-primary-900 mb-2">Current Breakpoint</h3>
          <div class="grid grid-cols-1 md:grid-cols-4 gap-4 text-sm">
            <div class="p-3 rounded {currentBreakpoint === 'mobile' ? 'bg-primary-100 border-2 primary-blue-500' : 'bg-neutral-100'}">
              <div class="font-medium">Mobile</div>
              <div class="text-gray-600">&lt; 768px</div>
            </div>
            <div class="p-3 rounded {currentBreakpoint === 'tablet' ? 'bg-primary-100 border-2 primary-blue-500' : 'bg-neutral-100'}">
              <div class="font-medium">Tablet</div>
              <div class="text-gray-600">768px - 1024px</div>
            </div>
            <div class="p-3 rounded {currentBreakpoint === 'desktop' ? 'bg-primary-100 border-2 primary-blue-500' : 'bg-neutral-100'}">
              <div class="font-medium">Desktop</div>
              <div class="text-gray-600">1024px - 1440px</div>
            </div>
            <div class="p-3 rounded {currentBreakpoint === 'wide' ? 'bg-primary-100 border-2 primary-blue-500' : 'bg-neutral-100'}">
              <div class="font-medium">Wide</div>
              <div class="text-neutral-600">&ge; 1440px</div>
            </div>
          </div>
        </div>
        ...
        <div class="bg-white border border-neutral-200 rounded-lg p-6">
          <h3 class="font-semibold text-neutral-900 mb-4">Layout Controls</h3>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4  2xl:grid-cols-5  gap-6">
          {#each sampleCards as card (card.id)}
            <div class="bg-white border border-neutral-200 rounded-lg p-6 hover:shadow-lg transition-shadow">
              ...
              <p class="text-neutral-600 text-sm mb-4">{card.description}</p>
    ...
    >
      <div class="p-6 space-y-4">
        <h4 class="font-semibold text-neutral-900">Drawer Content</h4>
        ...
        <div class="space-y-3">
          <div class="p-3 bg-neutral-50 rounded-lg">
            <div class="font-medium text-sm text-neutral-900">Feature 1</div>
            <div class="text-xs text-neutral-600">Working correctly ✅</div>
          </div>
          <div class="p-3 bg-neutral-50 rounded-lg">
            <div class="font-medium text-sm text-neutral-900">Feature 2</div>
            <div class="text-xs text-neutral-600">Working correctly ✅</div>
          </div>
          <div class="p-3 bg-neutral-50 rounded-lg">
            <div class="font-medium text-sm text-neutral-900">Feature 3</div>
            <div class="text-xs text-neutral-600">Working correctly ✅</div>
          </div>
        </div>
      </div>
