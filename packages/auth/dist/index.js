...
var EmailService = class {
  ...
  static async sendParentPasswordReset(email, resetToken, resetUrl) {
  ...
  static async sendParentEmailVerification(email, verificationToken, verificationUrl) {
  ...
  static getParentPasswordResetTemplate(resetToken, resetUrl) {
    return `
			<!DOCTYPE html>
			<html>
			<head>
			...
			<body>
				<div class="container">
					<div class="header">
						<div class="logo">\u{1F393} Lexi Parent Portal</div>
  ...
  static getParentEmailVerificationTemplate(verificationToken, verificationUrl) {
    return `
			<!DOCTYPE html>
			<html>
			<head>
			...
			<body>
				<div class="container">
					...
					<div class="feature">
						<div class="feature-icon">\u{1F465}</div>
						<div>
