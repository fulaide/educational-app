 ...
 */
export function getCurrentBreakpoint(width = typeof window !== 'undefined' ? window.innerWidth : 1024, breakpoints = DEFAULT_BREAKPOINTS) {
 ...
 */
export function isBreakpoint(target, width = typeof window !== 'undefined' ? window.innerWidth : 1024, breakpoints = DEFAULT_BREAKPOINTS) {
 ...
 */
export function createMediaQuery(breakpoint, breakpoints = DEFAULT_BREAKPOINTS) {
