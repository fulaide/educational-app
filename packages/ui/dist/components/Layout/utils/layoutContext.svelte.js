...
export function createLayoutContext(initialState) {
    ...
    const breakpointState = $state({
        current: breakpointStore.current,
 ...
 */
export function setLayoutContext(context) {
...
export function getLayoutContext() {
    ...
    if (!context) {
        throw new Error('Layout context not found. Make sure to wrap your app with <AppLayout> component.');
    }
    return context;
}
/**
