...
function getCurrentBreakpoint(width: number, breakpoints: BreakpointConfig = DEFAULT_BREAKPOINTS): Breakpoint {
 ...
 */
export function createReactiveBreakpoint(breakpoints: BreakpointConfig = DEFAULT_BREAKPOINTS) {
