...
export type {
  ...
  NavigationSection,
  LayoutEvents
} from './AppLayout/AppLayout.types.js';
...
export type {
  ...
  GridGap,
  ResponsiveGrid
} from './MainContent/MainContent.types.js';
...
} from './ResponsiveContainer/ResponsiveContainer.types.js';